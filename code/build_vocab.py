...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='D:\cdktz\实验笔记\lyy-keti\Pesudo_Sequence\Kcat-pesudo sequence\data\Kcat Conserved domain data（batch _CD_Search)\chembl25_corpus.txt', help='path to th ecorpus')
    parser.add_argument('--out_path', '-o', type=str, default='vocab1.pkl', help='output file')
